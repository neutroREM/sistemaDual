    ...
    public partial class initialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignaturaAD", x => x.AsignaturaID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstatusAD", x => x.EstatusID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<int>(type: "int", maxLength: 12, nullable: false),
                    Cargo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    UniversidadID = table.Column<string>(type: "nvarchar(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlumnoDual_EstatusAD_EstatusID",
                        column: x => x.EstatusID,
                        principalTable: "EstatusAD",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlumnoAsignaturas_AsignaturaAD_AsignaturaID1",
                        column: x => x.AsignaturaID1,
                        principalTable: "AsignaturaAD",
